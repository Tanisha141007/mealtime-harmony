...
export const demoPrefs: Prefs = {
  ...
  sendTime: "09:00",
  cookMessageSchedule: {
    monday: [{ enabled: true, time: "09:00", meals: ["lunch"], message: "Please prep lunch first." }],
    ...
    saturday: [{ enabled: true, time: "10:00", meals: ["breakfast", "lunch"], message: "" }],
    sunday: [{ enabled: true, time: "10:00", meals: ["breakfast", "lunch"], message: "" }],
  },
